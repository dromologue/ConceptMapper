...
**AC-061E-07**: Flow and radial layout target positions scale their spacing (depth gaps, node gaps, ring gaps) proportionally to font scale, so preset layouts also adjust.
