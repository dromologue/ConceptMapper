...
| REQ-119 | AC-119-01..06 | `web/src/hooks/useViewport.ts`, `web/src/App.tsx`, `web/src/App.css`, `web/src/stores/useUIStore.ts`, `ios/ConceptMapperUITests/ConceptMapperUITests.swift` | viewport classify + phone default + drawer/bottom-sheet overlays | passing |
